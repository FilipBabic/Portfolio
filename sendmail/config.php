...
define('CONTACTFORM_FROM_NAME', 'Email sent from my portfolio web site');
...
define('CONTACTFORM_TO_ADDRESS', 'filip1986babic@gmail.com');
define('CONTACTFORM_TO_NAME', 'Filip Babic');

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.gmail.com');
define('CONTACTFORM_SMTP_USERNAME', 'filip1986babic@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'uogh ipey sstv gejz');

// The reCAPTCHA credentials for your site. You can get these at https://www.google.com/recaptcha/admin
define('CONTACTFORM_RECAPTCHA_SITE_KEY', '6Lfs8W4oAAAAADApxbfyltUwEzSJlnoUtgYVWSo8');
define('CONTACTFORM_RECAPTCHA_SECRET_KEY', '6Lfs8W4oAAAAAKkiaj_exoWzs0GnRJi52G8hIoaF');
